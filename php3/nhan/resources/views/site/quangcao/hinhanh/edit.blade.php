...
@section('main')
    ...
    <form method="post" action="{{ route('quangcao.update', $row->id_quangcao) }}">
        {{ csrf_field() }}
        {!! method_field('put') !!}
        <div class="container">
        ...
        <div class="form-group mg-b-20">
            <input type="text" name="yeucau" class="form-control" placeholder="Nhập yêu cầu cần có trong bài báo" required value="{{$row->yeucau}}">
        </div>
            <div class="form-group mg-b-20">
            ...
            <div class="d-flex justify-content-around">
                ...
                <div class="d-flex form-group mg-b-20">
                    ...
                    <label class="radiobox">
                        <?php 
                            if($row->id_loaiquangcao == $value->id){?>
                                                        <input type="radio" name="id_loaiquangcao" value="{{$value->id}}" checked>

                           <?php }elseif($row->id_loaiquangcao != $value->id){ ?>
