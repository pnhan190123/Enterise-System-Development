...
@section('main')
    ...
    <form method="post" action="{{ route('quangcaoEditor.update', $row->id_quangcao) }}">
        {{ csrf_field() }}
        {!! method_field('put') !!}
        <div class="container">
        ...
        <div class="form-group mg-b-20">
            ...
            <div class="form-group mg-b-20">
                ...
                <img src="http://localhost:8080/php3/nhan/storage/app/public/photos/{{$row->idUser}}/{{$row->urlHinh}}" style="width: 300px;height:200px">
