...
<form method="post" action="{{ route('quangcaoEditor.getComboNews') }}">
    {{ csrf_field() }}
    <div class="col-9 mg-l-30" style="margin: 0 auto;">
        <div class="d-flex flex-column">
            <div class="form-group mb-b-20">
                ...
                <input type="text" name="ten_loai" placeholder="Nhập tên dịch vụ" class="form-control" required>
            </div>
            <div class="form-group mg-b-20">
                <label for="">Tiền dịch vụ:</label>
                <input type="number" name="gialoai" placeholder="Nhập tiền dịch vụ" class="form-control" required>
            </div>
