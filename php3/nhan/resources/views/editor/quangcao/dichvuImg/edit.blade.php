...
<form method="post" action="{{route('quangcaoEditor.updatelist', $row->id) }}">
    {{ csrf_field() }}
    {!! method_field('post') !!}
    <div class="col-9 mg-l-30" style="margin: 0 auto;">
        <div class="d-flex flex-column">
            ...
            <div class="form-group mg-b-20">
                ...
                <input type="text" name="thoigian" placeholder="Nhập tiền dịch vụ" value="{{ $row->thoigian}}" class="form-control">
            </div>
        </div>
