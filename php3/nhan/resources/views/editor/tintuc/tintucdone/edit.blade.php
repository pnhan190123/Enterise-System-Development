...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.7.14/css/bootstrap-datetimepicker.min.css">
    ...
    <form method="post" action="{{ route('tintucEditor.update', $row->idTin) }}">
        {{ csrf_field() }}
        {!! method_field('patch') !!}
        <div class="container">
            ...
            <div style="text-align: center;">
                    <img src="http://localhost:8080/php3/nhan/storage/app/public/photos/{{$row->idUser}}/{{ $row->urlHinh }}" alt="Ảnh bìa" style="width: 700px; height:500px;">
