...
class TintucController extends Controller
{
    ...
    {   
        ...
        return view('admin.tintuc.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.tintuc.create', $this->data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $t->slug_tin= $slug;
        $t->save();
    return redirect('/admin/tintuc')->with('mess', 'Tin mới đã được lưu')->with('class', 'primary');
    }
    ...
    public function edit($id)
    {
        ...
        if ($row == null) {
            ...
            return view("admin.tintuc.edit", $this->data);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/tintuc')->with('mess', 'Tin ID '. $id .' đã được cập nhật')->with('class', 'primary');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($tin == null) {
            ...
            if ($countYkien == 0) {
                $tin->delete();
                return redirect('/admin/tintucDuyet')->with('mess', 'Đã xóa tin id = ' . $id)->with('class', 'primary');
            } else {
                return redirect('/admin/tintucDuyet')->with('mess', 'Tin ID ' . $id . ' Còn ý kiến của tin nên không thể xóa !')
                    ->with('class', 'danger');
            }
        }
    }
