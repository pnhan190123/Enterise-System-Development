...
class SecretariatYkienController extends Controller
{
    public $pages = [
    ...
    public function index()
    {
        ...
        return view('secretariat.ykien.index', $this->data);
        // return dd(Auth::id())
    }
    ...
    public function create()
    {
        ...
        return view('secretariat.loaitin.create', $this->data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/secretariat/loaitinSecretariat')->with('mess', 'Loại tin đã được lưu')->with('class', 'primary');
    }
    ...
    public function edit($id)
    {
        ...
        if ($row == null) {
            ...
            return view("secretariat.loaitin.edit", $this->data);
        }
    }
    ...
    public function destroy($id)
    {
        $ykien = ykien::find($id);
        if ($ykien == null) {
          return redirect('/secretariat/ykienSecretariat')->with('mess', 'Ý kiến không tồn tại')->with('class', 'danger');
        } else {
					$ykien->delete();
					return redirect('/secretariat/ykienSecretariat')->with('mess', 'Đã xóa ý kiến id = ' . $id)->with('class', 'primary');
        }
    }

    public function changeStatusShow($id, $anhien) {
        $dichvu = dichvu::find($id);
        $dichvu->AnHien = $anhien;
        $dichvu->save();
        return redirect('/secretariat/ykienSecretariat')->with('mess', 'Đổi trạng thái ẩn hiện cho ý kiến id = ' .$id. ' thành công')->with('class', 'primary');
    }
}
