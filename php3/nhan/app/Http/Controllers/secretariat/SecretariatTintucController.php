...
class SecretariatTintucController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('secretariat.tintuc.create', $this->data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $t->slug_tin= $slug;
        $t->save();
    return redirect('/secretariat/tintucSecretariat')->with('mess', 'Tin mới đã được lưu')->with('class', 'primary');
    }
    ...
    public function edit($id)
    {
        ...
        if ($row == null) {
            ...
            return view("secretariat.tintuc.edit", $this->data);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/secretariat/tintucSecretariat')->with('mess', 'Tin ID '. $id .' đã được cập nhật')->with('class', 'primary');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($tin == null) {
            ...
            if ($countYkien == 0) {
                $tin->delete();
                return redirect('/secretariat/tintucSecretariat')->with('mess', 'Đã xóa tin id = ' . $id)->with('class', 'primary');
            } else {
                return redirect('/secretariat/tintucSecretariat')->with('mess', 'Tin ID ' . $id . ' Còn ý kiến của tin nên không thể xóa !')
                    ->with('class', 'danger');
            }
        }
    }
